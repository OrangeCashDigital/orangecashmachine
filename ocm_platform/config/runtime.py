...
``from ocm_platform.config.runtime import RunConfig`` siguen funcionando.

Migración: actualizar imports a ``from core.runtime import RunConfig``
o ``from ocm_platform.runtime.run_config import RunConfig``.
"""

from ocm_platform.runtime.run_config import RunConfig  # noqa: F401
