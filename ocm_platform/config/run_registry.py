...
``from ocm_platform.config.run_registry import record_run`` siguen funcionando.

Migración: actualizar imports a ``from core.runtime import record_run``
o ``from ocm_platform.runtime.registry import record_run``.
"""

from ocm_platform.runtime.registry import record_run, query_runs  # noqa: F401
