...
``from core.config.runtime import RunConfig`` siguen funcionando.

Migración: actualizar imports a ``from core.runtime import RunConfig``
o ``from core.runtime.run_config import RunConfig``.
"""

from core.runtime.run_config import RunConfig  # noqa: F401
