...
def _build_parser() -> argparse.ArgumentParser:
    ...
    # Capital y riesgo
    p.add_argument("--capital", type=float, default=10_000.0, help="Capital virtual en USD")
    p.add_argument(
        "--max-risk-pct",
        type=float,
        default=0.05,
...
def main(argv: list[str] | None = None) -> int:
    ...
    logger.info(
        "Paper trading iniciando | exchange={} symbol={} tf={} market_type={} ema={}/{} capital={:.0f} dry_run={}",
        args.exchange,
        args.symbol,
        args.timeframe,
        args.market_type,
