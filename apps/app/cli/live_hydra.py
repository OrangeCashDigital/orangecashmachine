...
CLI oficial de live trading (ADR-0005) — reemplazo definitivo de
app/cli/live.py, retirado del arbol (ya no existe). El entrypoint de
live trading en el CLI es este modulo; ver ADR-0005.
