...
``from platform.config.lineage import get_git_hash`` siguen funcionando.

Migración: actualizar imports a ``from core.runtime import get_git_hash``
o ``from platform.runtime.lineage import get_git_hash``.
"""

from platform.runtime.lineage import (  # noqa: F401
    get_git_hash,
    build_lineage,
    LineageRecord,
)
