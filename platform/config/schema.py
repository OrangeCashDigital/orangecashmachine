...
from platform.config.layers.coercion import BOOL_TRUE as _ENV_BOOL_TRUE   # noqa: E402
from platform.config.layers.coercion import BOOL_FALSE as _ENV_BOOL_FALSE  # noqa: E402
...
class ExchangeConfig(StrictBaseModel):
    ...
    def resolve_credentials(cls, values: dict[str, Any]) -> dict[str, Any]:
        ...
        from platform.config.credentials import resolve_exchange_credentials
    ...
    def validate_credentials(self) -> ExchangeConfig:
        ...
        """
        from platform.config.env_vars import OCM_ENV as _OCM_ENV  # import local: solo constante str
