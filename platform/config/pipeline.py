...
from platform.config.hydra_loader import strip_hydra_internals
from platform.config.layers.coercion import coerce_scalar_values
...
class ConfigPipeline:
    ...
    def _l2_env_override(self, cfg: DictConfig) -> tuple[DictConfig, int]:
        ...
        """
        try:
            from platform.config.layers.env_override import apply_env_overrides
    ...
    def _l4_validate(self, raw_dict: dict) -> Any:
        ...
        """
        try:
            from platform.config.layers.validation import validate_and_coerce
    ...
    def _l5_business_rules(self, app_config: Any) -> Any:
        ...
        """
        try:
            from platform.config.layers.rules import apply_business_rules
