...
``from platform.config.runtime_context import RuntimeContext`` siguen funcionando.

Migración: actualizar imports a ``from core.runtime import RuntimeContext``
o ``from platform.runtime.context import RuntimeContext``.
"""

from platform.runtime.context import RuntimeContext  # noqa: F401
