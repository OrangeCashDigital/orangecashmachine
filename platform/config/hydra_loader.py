...
from platform.config.schema import AppConfig
from platform.config.loader.snapshot import write_config_snapshot
...
def hydra_cfg_to_appconfig(cfg: DictConfig) -> AppConfig:
    ...
    """
    from platform.config.pipeline import ConfigPipeline
...
def load_appconfig_standalone(
    ...
    *,
    ...
    """
    from platform.config.loader.env_resolver import resolve_env, load_dotenv_for_env
