...
Razón: el registro de runs es estado de ejecución, no configuración
...
Uso
---
    from platform.runtime.registry import record_run, query_runs
...
def query_runs(
    *,
    ...
    Returns [] si SQLite no existe o falla — SafeOps.
    """
    try:
