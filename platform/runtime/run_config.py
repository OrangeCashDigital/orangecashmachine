...
from platform.config.env_vars import (
    OCM_CONFIG_DIR,
    OCM_CONFIG_PATH,
    OCM_DEBUG,
    OCM_VALIDATE_ONLY,
...
from platform.config.layers.coercion import BOOL_TRUE  # SSOT — única fuente de verdad para bool strings
