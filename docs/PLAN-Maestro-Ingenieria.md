...
| 2026-08-23 | (B-50) | **B-50 CERRADO**: pip-audit vulnerabilities (aiohttp 3.14.1→3.14.3, cryptography 49.0.0→50.0.0) ya resueltas en commit 876cf38 (bump ccxt 4.5.70→4.5.74). Fix transitivo (aiohttp vía ccxt/cryptofeed; cryptography vía python-jose). pip-audit → exit 0. No se requiere ADR ni risk-accept. |
