...
- **Avance (2026-08-23):** audit_validator.py implementa M22–M25 (ADR-0031); policies/registry.yaml creado (PR #19). Contratos: 50 KEPT. **B-47 cerrado:** ruff select activa C901/PLR/SIM; ignore PLR2004/0913/0912/0911/0915; 79 violaciones baseline documentadas; 12 auto-fix aplicados.
...
| 2026-08-23 | (B-47) | **B-47 CERRADO**: ruff select activa C901/PLR/SIM (F-PLA-01); ignore PLR2004/0913/0912/0911/0915 (263 violaciones avoided); 79 violaciones baseline documentadas; 12 auto-fix aplicados; per-file ignore SIM114 stop_loss.py. Quality gates: ruff ✓, format ✓, 1248 tests ✓, 50 contracts KEPT ✓, mypy ✓. |
