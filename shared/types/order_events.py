...
shared/kafka/schemas/orders.py (OrderFilledPayload, OrderRejectedPayload).
Estos DomainEvents permanecen como modelo de dominio interno en memoria,
pensado como evolución prevista de los wire payloads. No se serializan hoy:
los publishers traducen a los wire payloads en la frontera del bus.
