...
---
    ...
    python -m market_data.batch.storage.bronze_retention

    # Ejecutar limpieza real
    python -m market_data.batch.storage.bronze_retention --execute

    # Retención agresiva (3 días)
    python -m market_data.batch.storage.bronze_retention --days 3 --execute
"""
