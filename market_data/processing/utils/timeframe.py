...
# ==========================================================
# Re-export de compatibilidad — align_to_grid
# ==========================================================
# align_to_grid fue movida a processing/utils/grid_alignment.py
# para separar el value object puro (timeframe) de la lógica de
# aplicación que requiere pandas y Prometheus.
#
# Este re-export mantiene compatibilidad con todos los imports existentes:
#   from market_data.processing.utils.timeframe import align_to_grid
#
# Migración futura: actualizar imports directamente a grid_alignment.
from market_data.processing.utils.grid_alignment import align_to_grid  # noqa: F401
